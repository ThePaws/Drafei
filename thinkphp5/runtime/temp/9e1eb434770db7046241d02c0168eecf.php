<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./../application/admin\view\productcate\edit.html";i:1530709855;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form class="form form-horizontal" id="new_form" >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="f_id" class="select">
				<?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($data['f_id']==$vo['id']): ?>
...
<script type="text/javascript">
	function Formadd(){
  	var data = new FormData($("#new_form")[0]);
        $.ajax({
            url:'<?php echo url('Productcate/edit'); ?>',
            type:'post',
            data: data,
            dataType: 'json',
