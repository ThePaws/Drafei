<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./../application/index\view\base.html";i:1531313412;s:49:"./../application/index\view\productcate\read.html";i:1531314888;s:61:"D:\wo\phpstudy\WWW\thinkphp5\application\index\view\base.html";i:1531313412;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 <link rel="stylesheet" href="/static/home/css/shop_list.css">
...
<div id="middle" class="clearfix">
    ...
    <div class="shop_list_big">
        ...
        <?php if(is_array($product) || $product instanceof \think\Collection || $product instanceof \think\Paginator): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li>
                <a href="<?php echo url('/Index/Prodetails/prodetails'); ?>?id=<?php echo $vo['p_id']; ?>"><img src="<?php echo $vo['path']['0']['p_thumb_path']; ?>"></a>
                <div class="list_content">
                    <p><a href="<?php echo url('/Index/Prodetails/prodetails'); ?>?id=<?php echo $vo['p_id']; ?>""><?php echo $vo['p_name']; ?></a> </p>
                    <span>¥<?php echo $vo['show_price']; ?></span>
                    <div class="list_bottom clearfix">
                        <a href="<?php echo url('/Index/Prodetails/prodetails'); ?>?id=<?php echo $vo['p_id']; ?>"">热卖</a>
                    </div>
                </div>
            </li>
         <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <script>
            $(function () {
                $('.shop_list_big>.list_goods>li').each(function (i) {
                    $(this).css('margin-left','64px');
                    $('.list_goods>li').eq(0).css('margin-left','0');
                    $('.list_goods>li').eq(4).css('margin-left','0');
                    $('.list_goods>li').eq(8).css('margin-left','0');
                    $('.list_goods>li').eq(12).css('margin-left','0');
                });
            });
