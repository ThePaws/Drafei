<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./../application/admin\view\productcate\read.html";i:1531303584;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="page-container">
		...
		<div class="mt-20" id="addlist">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
			    ...
			    <tr class="text-c">
				<td><input type="checkbox" value="<?php echo $vo['id']; ?>" name="value_id"></td>
				<td><?php echo $vo['id']; ?></td>
				<td class="text-l"><?php echo $vo['name']; ?></td>
				<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','/admin/Productcate/edit/id/<?php echo $vo['id']; ?>/name/<?php echo $vo['name']; ?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del_one(<?php echo $vo['id']; ?>)" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			  </tr>
...
function article_del(){
  ...
  { 
    ...
    $.ajax({
			type: 'POST',
			url: "<?php echo url('Productcate/delete'); ?>",
			dataType: 'json',
